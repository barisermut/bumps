...
function buildMentorPromptBundle(parsedData, mirrorInsights, filter = {}) {
  ...
  function assemblePrompt(rows, arcs) {
    return [
      ...
      "",
      "Prefer patterns that span at least 3 sessions across at least 2 projects when possible. A pattern confined to a single session is not a behavioral pattern — it's an incident.",
